...
{
    /// <inheritdoc />
    public partial class InitialIdentityHealthcare : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeServiceRequests_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HomeServiceRequests_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalTasks_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MedicalTasks_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medications_MedicalTasks_MedicalTaskId",
                        column: x => x.MedicalTaskId,
                        principalTable: "MedicalTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeServiceRequests_NurseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalTasks_DoctorId",
                table: "MedicalTasks",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTasks_PatientId",
                table: "MedicalTasks",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Medications_MedicalTaskId",
                table: "Medications",
                column: "MedicalTaskId");
